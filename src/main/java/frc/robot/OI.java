...
public class OI {
  ...
  public static Joystick getRightDriveStick() { return rightDriveStick; }

  public static Joystick getLeftDriveStick() { return leftDriveStick; }

  public static Joystick getAuxStick() { return auxStick; }
  /* CREATING BUTTONS
  ...
  Additionally, by subclassing Button you can create custom triggers. and bind those to commands the same as any other Button.
