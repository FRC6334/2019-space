...
public class RobotMap {
  ...
  public static final float speedLimiter = 0.5f; // Out of 1.0, this value represents the max speed that the robot will go. 0.8, for example, means 80% max motor speed
}